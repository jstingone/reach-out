...
km_df = insight_covid_encounters_nevi %>% 
  ...
  mutate(nevi = nevi - vector_averages[[2]][6],
        ...
        no_hyper = dplyr::case_when(
            hyper == 1 ~ 0,
            hyper == 0 ~ 1
        ))

#Removing individuals with missing BMI and all those under 20 years of age
...
## 3 Recode AP (based on zip code) for Categorical Analyses
...
coxph_phase2and3_lownevi <- subset(coxph_phase2and3_df, nevi_tertiles == "Low")
coxph_phase2and3_mediumnevi <- subset(coxph_phase2and3_df, nevi_tertiles == "Medium")
coxph_phase2and3_highnevi <- subset(coxph_phase2and3_df, nevi_tertiles == "High")
...
coxph_phase2and3_40cov_lownevi <- subset(coxph_phase2and3_40cov, nevi_tertiles == "Low")
coxph_phase2and3_40cov_mediumnevi <- subset(coxph_phase2and3_40cov, nevi_tertiles == "Medium")
coxph_phase2and3_40cov_highnevi <- subset(coxph_phase2and3_40cov, nevi_tertiles == "High")
...
coxph_phase1_lownevi_blackrace <- subset(coxph_phase1_df_blackrace, nevi_tertiles == "Low")
coxph_phase1_mediumnevi_blackrace <- subset(coxph_phase1_df_blackrace, nevi_tertiles == "Medium")
coxph_phase1_highnevi_blackrace <- subset(coxph_phase1_df_blackrace, nevi_tertiles == "High")

coxph_phase2and3_lownevi_blackrace <- subset(coxph_phase2and3_df_blackrace, nevi_tertiles == "Low")
coxph_phase2and3_mediumnevi_blackrace <- subset(coxph_phase2and3_df_blackrace, nevi_tertiles == "Medium")
coxph_phase2and3_highnevi_blackrace <- subset(coxph_phase2and3_df_blackrace, nevi_tertiles == "High")

coxph_phase1_40cov_lownevi_blackrace <- subset(coxph_phase1_40cov_blackrace, nevi_tertiles == "Low")
coxph_phase1_40cov_mediumnevi_blackrace <- subset(coxph_phase1_40cov_blackrace, nevi_tertiles == "Medium")
coxph_phase1_40cov_highnevi_blackrace <- subset(coxph_phase1_40cov_blackrace, nevi_tertiles == "High")

coxph_phase2and3_40cov_lownevi_blackrace <- subset(coxph_phase2and3_40cov_blackrace, nevi_tertiles == "Low")
coxph_phase2and3_40cov_mediumnevi_blackrace <- subset(coxph_phase2and3_40cov_blackrace, nevi_tertiles == "Medium")
coxph_phase2and3_40cov_highnevi_blackrace <- subset(coxph_phase2and3_40cov_blackrace, nevi_tertiles == "High")


coxph_phase1_lownevi_whiterace <- subset(coxph_phase1_df_whiterace, nevi_tertiles == "Low")
coxph_phase1_mediumnevi_whiterace <- subset(coxph_phase1_df_whiterace, nevi_tertiles == "Medium")
coxph_phase1_highnevi_whiterace <- subset(coxph_phase1_df_whiterace, nevi_tertiles == "High")

coxph_phase2and3_lownevi_whiterace <- subset(coxph_phase2and3_df_whiterace, nevi_tertiles == "Low")
coxph_phase2and3_mediumnevi_whiterace <- subset(coxph_phase2and3_df_whiterace, nevi_tertiles == "Medium")
coxph_phase2and3_highnevi_whiterace <- subset(coxph_phase2and3_df_whiterace, nevi_tertiles == "High")

coxph_phase1_40cov_lownevi_whiterace <- subset(coxph_phase1_40cov_whiterace, nevi_tertiles == "Low")
coxph_phase1_40cov_mediumnevi_whiterace <- subset(coxph_phase1_40cov_whiterace, nevi_tertiles == "Medium")
coxph_phase1_40cov_highnevi_whiterace <- subset(coxph_phase1_40cov_whiterace, nevi_tertiles == "High")

coxph_phase2and3_40cov_lownevi_whiterace <- subset(coxph_phase2and3_40cov_whiterace, nevi_tertiles == "Low")
coxph_phase2and3_40cov_mediumnevi_whiterace <- subset(coxph_phase2and3_40cov_whiterace, nevi_tertiles == "Medium")
coxph_phase2and3_40cov_highnevi_whiterace <- subset(coxph_phase2and3_40cov_whiterace, nevi_tertiles == "High")


##Ethnicity & NEVI

coxph_phase1_lownevi_hispanic <- subset(coxph_phase1_df_hispanic, nevi_tertiles == "Low")
coxph_phase1_mediumnevi_hispanic <- subset(coxph_phase1_df_hispanic, nevi_tertiles == "Medium")
coxph_phase1_highnevi_hispanic <- subset(coxph_phase1_df_hispanic, nevi_tertiles == "High")

coxph_phase2and3_lownevi_hispanic <- subset(coxph_phase2and3_df_hispanic, nevi_tertiles == "Low")
coxph_phase2and3_mediumnevi_hispanic <- subset(coxph_phase2and3_df_hispanic, nevi_tertiles == "Medium")
coxph_phase2and3_highnevi_hispanic <- subset(coxph_phase2and3_df_hispanic, nevi_tertiles == "High")

coxph_phase1_40cov_lownevi_hispanic <- subset(coxph_phase1_40cov_hispanic, nevi_tertiles == "Low")
coxph_phase1_40cov_mediumnevi_hispanic <- subset(coxph_phase1_40cov_hispanic, nevi_tertiles == "Medium")
coxph_phase1_40cov_highnevi_hispanic <- subset(coxph_phase1_40cov_hispanic, nevi_tertiles == "High")

coxph_phase2and3_40cov_lownevi_hispanic <- subset(coxph_phase2and3_40cov_hispanic, nevi_tertiles == "Low")
coxph_phase2and3_40cov_mediumnevi_hispanic <- subset(coxph_phase2and3_40cov_hispanic, nevi_tertiles == "Medium")
coxph_phase2and3_40cov_highnevi_hispanic <- subset(coxph_phase2and3_40cov_hispanic, nevi_tertiles == "High")


coxph_phase1_lownevi_nonhispanic <- subset(coxph_phase1_df_nonhispanic, nevi_tertiles == "Low")
coxph_phase1_mediumnevi_nonhispanic <- subset(coxph_phase1_df_nonhispanic, nevi_tertiles == "Medium")
coxph_phase1_highnevi_nonhispanic <- subset(coxph_phase1_df_nonhispanic, nevi_tertiles == "High")

coxph_phase2and3_lownevi_nonhispanic <- subset(coxph_phase2and3_df_nonhispanic, nevi_tertiles == "Low")
coxph_phase2and3_mediumnevi_nonhispanic <- subset(coxph_phase2and3_df_nonhispanic, nevi_tertiles == "Medium")
coxph_phase2and3_highnevi_nonhispanic <- subset(coxph_phase2and3_df_nonhispanic, nevi_tertiles == "High")

coxph_phase1_40cov_lownevi_nonhispanic <- subset(coxph_phase1_40cov_nonhispanic, nevi_tertiles == "Low")
coxph_phase1_40cov_mediumnevi_nonhispanic <- subset(coxph_phase1_40cov_nonhispanic, nevi_tertiles == "Medium")
coxph_phase1_40cov_highnevi_nonhispanic <- subset(coxph_phase1_40cov_nonhispanic, nevi_tertiles == "High")

coxph_phase2and3_40cov_lownevi_nonhispanic <- subset(coxph_phase2and3_40cov_nonhispanic, nevi_tertiles == "Low")
coxph_phase2and3_40cov_mediumnevi_nonhispanic <- subset(coxph_phase2and3_40cov_nonhispanic, nevi_tertiles == "Medium")
coxph_phase2and3_40cov_highnevi_nonhispanic <- subset(coxph_phase2and3_40cov_nonhispanic, nevi_tertiles == "High")
