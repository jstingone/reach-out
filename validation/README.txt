This folder contains documents used to support the comparison of INSIGHT COVID populations to COVID datasets derived from data provided by individual institutions.
...
* Institutional_Data_Mount_Sinai.RMD: File containing programming code to get descriptives from each institution, without having to share data. Derived variable naming was tailored to each instituion for visualization of output. Showing Mount Sinai as example
